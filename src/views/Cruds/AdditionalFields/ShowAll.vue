  ...
  <div class="show_all_content_wrapper">
    ...
    <main>
        ...
        <div class="filter_form_wrapper">
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <!-- Start:: Name Input -->
              <base-input col="6" type="text" :placeholder="$t('PLACEHOLDERS.additional_field')"
              ...
              <base-select-input col="6" :optionsList="allVehicleTypes" :placeholder="$t('PLACEHOLDERS.type_vechile')"
                v-model="filterOptions.vehicle_type" />
      ...
      <v-data-table class="thumb" :loading="loading" :loading-text="$t('TABLES.loadingData')" :search="searchValue"
        ...
        <template v-slot:[`item.vehicleTypes`]="{ item }">
          <h6 class="text-danger" v-if="!item.vehicleTypes"> {{ $t("TABLES.noData") }} </h6>
          <div v-else v-for="(item, index) in item.vehicleTypes" :key="'p' + index">
      ...
      try {
        let res = await this.$axios({
          ...
          params: {
            ...
            vehicle_id: this.filterOptions.vehicle_type?.id,
          },
        });
        this.loading = false;
