    ...
    <main>
      ...
      <div class="table_title_wrapper">
        <div class="title_text_wrapper">
          <h5>{{ $t("SIDENAV.Services.title") }}</h5>
        ...
        <div class="title_route_wrapper" v-if="$can('services create', 'services')">
      ...
      <v-data-table class="thumb" :loading="loading" :loading-text="$t('TABLES.loadingData')" :search="searchValue"
        ...
        <template v-slot:[`item.is_active`]="{ item }">
          <div class="activation" dir="ltr" style="z-index: 1" v-if="$can('services activate', 'services')">
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            ...
            <a-tooltip placement="bottom" v-if="$can('services show', 'services')">
              <template slot="title">
            ...
            <a-tooltip placement="bottom" v-if="$can('services edit', 'services')"
            ...
            <a-tooltip placement="bottom" v-if="$can('services delete', 'services')"
