  ...
  <div class="show_all_content_wrapper">
    ...
    <main>
        ...
        <div class="filter_form_wrapper">
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <!-- Start:: Name Input -->
              <base-input col="4" type="text" :placeholder="$t('TABLES.Addresses.area')"
      ...
      <div class="table_title_wrapper">
        ...
        <div class="title_route_wrapper" v-if="$can('districts create', 'districts')">
      ...
      <v-data-table class="thumb" :loading="loading" :loading-text="$t('TABLES.loadingData')" :search="searchValue"
        ...
        <template v-slot:[`item.is_active`]="{ item }">
          <div class="activation" dir="ltr" style="z-index: 1" v-if="$can('districts activate', 'districts')">
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            ...
            <a-tooltip placement="bottom" v-if="$can('districts edit', 'districts')">
              <template slot="title">
            ...
            <a-tooltip placement="bottom" v-if="$can('districts delete', 'districts')">
              <template slot="title">
