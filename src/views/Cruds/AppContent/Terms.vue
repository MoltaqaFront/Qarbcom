  ...
  methods: {
    ...
    async getDataToEdit() {
      try {
        ...
        // Start:: Set Data
        this.data.contentAr = res.data.data[1].content_ar;
        this.data.contentEn = res.data.data[1].content_en;
        this.data.nameAr = res.data.data[1].title_ar;
        this.data.nameEn = res.data.data[1].title_en;
        // End:: Set Data
      } catch (error) {
