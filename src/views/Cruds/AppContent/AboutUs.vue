  ...
  methods: {
    ...
    async getDataToEdit() {
      try {
        ...
        // Start:: Set Data
        this.data.contentAr = res.data.data[2].content_ar;
        this.data.contentEn = res.data.data[2].content_en;
        this.data.nameAr = res.data.data[2].title_ar;
        this.data.nameEn = res.data.data[2].title_en;
        // End:: Set Data
      } catch (error) {
    ...
    async submitForm() {
      ...
      REQUEST_DATA.append("slug[en]", this.data.nameEn);
      REQUEST_DATA.append("slug[ar]", this.data.nameAr);
