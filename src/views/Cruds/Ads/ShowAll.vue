  ...
  <div class="show_all_content_wrapper">
    ...
    <main>
      ...
      <div class="table_title_wrapper">
        ...
        <div class="title_route_wrapper" v-if="$can('sliders create', 'sliders')">
      ...
      <v-data-table class="thumb" :loading="loading" :loading-text="$t('TABLES.loadingData')" :search="searchValue"
        ...
        <template v-slot:[`item.is_active`]="{ item }">
          <div class="activation" dir="ltr" style="z-index: 1" v-if="$can('sliders activate', 'sliders')">
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            ...
            <a-tooltip placement="bottom" v-if="$can('sliders show', 'sliders')">
              <template slot="title">
            ...
            <a-tooltip placement="bottom" v-if="$can('sliders edit', 'sliders')"
            ...
            <a-tooltip placement="bottom" v-if="$can('sliders delete', 'sliders')"
    ...
    return {
      ...
      tableHeaders: [
        ...
        },
        {
          ...
          value: "start_publish_date",
          sortable: false,
          align: "center",
        },
        {
          text: this.$t("PLACEHOLDERS.end_date"),
          value: "end_publish_date",
          sortable: false,
          align: "center",
        },
        {
