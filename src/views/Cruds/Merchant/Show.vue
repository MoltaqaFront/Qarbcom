    ...
    <div class="single_step_form_content_wrapper">
      ...
      <form>
        <div class="row">
          ...
          <base-input col="6" type="text" disabled :placeholder="$t('PLACEHOLDERS.status')" v-model="data.active" />
          ...
          <!-- Start:: Name Input -->
          <base-input col="6" type="text" disabled :placeholder="$t('PLACEHOLDERS.phone_call')"
            v-model.trim="data.phone_call" />
          <!-- End:: Name Input -->

          <!-- Start:: Name Input -->
          <base-input col="6" type="text" disabled :placeholder="$t('PLACEHOLDERS.WhatsApp_contact')"
