        ...
        <div class="filter_form_wrapper">
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              <!-- Start:: Name Input -->
              <base-input col="3" type="text" :placeholder="$t('TABLES.Orders.driverName')"
  ...
  methods: {
    ...
    async changeAvailabilityStatus(item) {
      try {
        await this.$axios({
          method: "PUT",
          url: `admin/driver/active-in-active/${item.id}`,
          params: {
            fromOnline: true
          },
        });
    ...
    async HandlingItemActivationStatus(selectedItem) {
      ...
      try {
        ...
        await this.$axios({
          method: "PUT",
          url: `admin/driver/active-in-active/${this.changeStatus}`,
          params: {
    ...
    async confirmDeleteItem() {
      try {
        await this.$axios({
          method: "DELETE",
          url: `admin/driver/${this.itemToDelete.id}`
        });
